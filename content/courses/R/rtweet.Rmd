...
I set out to work with `rtweet` on some work-related Twitter handles and ended up discovering a bug and [a workaround for windows users](https://jimgruman.netlify.com/post/rtweet-on-windows/).
...
Unfortunately, the process currently works properly in linux environments, but not in Windows. To prove the point, closely inspect the token created as follows:
