---
title: ""Introduction to Machine Learning in the Tidyverse 02-Classification"
author: "Gruman"
date: "1/30/2020"
...
```{r}
# read in the data
download.file("https://github.com/rstudio-conf-2020/intro-to-ml-tidy/tree/master/materials/data/stackoverflow.rds", "./input/stackoverflow.rds" )

stackoverflow <- read_rds("./input/stackoverflow.rds")

file.remove("./input/stackoverflow.rds")
