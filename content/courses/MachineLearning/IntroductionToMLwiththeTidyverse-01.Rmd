...
[Github materials](https://github.com/rstudio-conf-2020/intro-to-ml-tidy)
...
Double check. Does the tidymodels approach
...
give the same results as the conventional approach?
...
rmse_test<-rmse(price_pred, truth = price_truth, estimate = .pred)
...
3. Extract the rmse- is it the same as what we just calculated in our previous exercise `r round(rmse_test$.estimate, 0)`?
