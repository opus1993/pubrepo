...
<b style='color:#440154FF'>Voted</b>
...
voters %>%
  ...
  labs(title ="Overall, is the economy getting better or worse, \n for those that <b style='color:#440154FF'>Voted</b> and <b style='color:#FDE725FF'>Did not vote</b> ?", caption = str_c("Jim Gruman, ", Sys.Date())) +
  theme(legend.position = "top"  ,
        plot.title.position = "plot")+     #tip from William R Chase at RStudio Conference 2020
