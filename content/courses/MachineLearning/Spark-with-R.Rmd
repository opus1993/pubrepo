...
[![Mastering Spark with R](img/mastering-spark-with-r.png)](https://therinspark.com/)
...
[![Introduction to Spark in R using sparklyr](img/shield_image_course_3309_20180726-12-1ek0ctx.png)]
(https://www.datacamp.com/courses/introduction-to-spark-in-r-using-sparklyr)

---------------------

To help us understand a definition of Apache Spark, we break it down as follows:
...
```{r install sparklyr, eval=FALSE, include=FALSE}
