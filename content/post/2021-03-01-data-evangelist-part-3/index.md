...
Kenny Ning's blog post on his poor experiences as a new hire tell the all-too-common story. The best tools are mostly open source. Much of the talent is already out there, and even upskilling is relatively inexpensive. Although the models may be complex, the delivery is user centric. Human in the loop Machine Learning is intentionally not disruptive to customer UX or company operations.
