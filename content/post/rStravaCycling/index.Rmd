...
<img src="https://fawda123.github.io/rStrava/man/figures/api_logo_pwrdBy_strava_horiz_light.png" align="left" width="350">
...
Business school masters programs cover data visualization and leadership communications at some level, often for a c-suite audience. Most every consultant's pitch deck has the same MBA style building blocks, for Powerpoint.

The emerging field of [data journalism](https://datajournalism.com/read/handbook/one/introduction/what-is-data-journalism) offers some hard won process concepts into what conveying insights through media to the broader world is becoming.
...
Data journalism can tell complex stories through infographics. Consider Hans Rosling’s spectacular talks on visualizing world poverty with [Gapminder](https://www.gapminder.org/). And David McCandless’s popular work in distilling big numbers shows the importance of clear design at [Information is Beautiful](https://informationisbeautiful.net/).

Often data-driven stories begin with resources in open source software, open access publishing and open data. Even a few businesses have noticed that the communication aspects of data science are critical unmet needs, to the point where they have invented yet another job title, [analytics translator](https://email.mg2.substack.com/c/eJw9kc1uhCAUhZ9m2I0RRMEFi276GoafOw6tgoFLHd--OKZNyCGcw80hH1YjzDEdaosZySkTHhuoAHteABESKRnS5J3qOR_HjhKnuKOyl8Tn6ZEAVu0XhakA2YpZvNXoYzgHmJB8JE8lTOc6oXvQTvCqTIhByx5aQXkvmblqdXEeggUFP5COGIAs6om45Vv3cWOfde373qz224cMR2PjWi1Tsg-Q8_1Rgj17czX_7tx10MuB3p5mLOleXT8_8Tz-R3dMOuRFY0zEK9Yy2o5MUtb2bGhYQzs3DMbIgRv2ANE3w-vVOe_cjbfrzJpcTEZtv8_3kKS-_NrMqaw61Hw-ybyDCmaq-1qCx2OCoM0C7mKGF_k3xWmGAKn-iJs0Kjp0THatqCLoxahC5VTSao6kNrtYp4KysQT0Yf4FNyyePw). I’m happy a few years later that the title seems not to have gained any traction, because it indicates that the work is being done and there’s no organizational gap elsewhere. Hopefully it’s data scientists taking up the work.

This leads me to a thought on others that fill these communications needs in many organizations. This short video montage from a spring 2021 conference conveys a broader perspective of what sorts of work roles are doing modern analytical work. 
