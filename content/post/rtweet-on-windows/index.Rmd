...
I was inspired by David Robinson's Tidy Tuesday screencast to work with `rtweet` on some familiar Twitter handles and ended up discovering a bug and a workaround for windows users. `rtweet` is an amazing way of having a little productive procrastination while honing R skills. David's video is here:
