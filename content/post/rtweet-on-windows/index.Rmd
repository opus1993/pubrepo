...
[Oscar Baruffa](https://twitter.com/OscarBaruffa) and [Veerle van Son](https://twitter.com/veerlevanson) have written a `bookdown` pamphlet [Twitter for R Programmers](https://www.t4rstats.com/) as an excellent guide for people new to the R community on Twitter.
...
```{r warning=FALSE, fig.align='center', fig.width=9, fig.height=5}
