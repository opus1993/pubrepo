...
`rtweet` is an amazing way of having a little productive procrastination while honing R skills
...
Some may prefer the `ggridges` version of the same data visualization
