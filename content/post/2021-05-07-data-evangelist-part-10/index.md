...
---
 ...
 On that theme, this brief post will cover a few thoughts on

-   Collaboration, 
-   Open source in heavy equipment,
-   Gartner Conference ,
-   Upcoming Events,
...
Shane Thomas observation

Syngenta observation
...
My colleague Andrew Olliver has been appointed Vice-Chairperson of the Agricultural Industry Electronics Foundation (AEF) for the next two years. The AEF counts eight manufacturers and three trade associations as core members together with over 200 general members. They work together to improve cross-manufacturer compatibility of electronic and electric components in agricultural equipment, and to establish transparency about compatibility issues, providing guidelines for internationally agreed best practices as well as technical specifications for tools, machinery and other products and processes
...
[Gartner Data & Analytics Summit – Americas](https://reg.gartner.com/flow/gartner/bi19v/attportal/page/home)

engage with peers, 
Solution Providers, 
and meet the Gartner Experts. 

guest keynotes

Get advice on what’s top of mind for you during interactive sessions such as 
Peer Conversations, 
Roundtables, 
Workshops, and 
Ask the Experts.

bringing back materials, sharing summaries to company Yammer
...
As a contrast to Gartner's generic, paywalled C-suite survey advisory approach, in this conversation IIA's Ken Sanford shares his experience along with a simple, effective framework for making data science tool stack choices, informed by specific needs, not by sales hype. 
...
Want to make a difference in our organization and for those you work with? CNH Industrial is now accepting interest forms for the development of Employee Resource Groups (ERGs) – a new channel for building communities that foster employee and organizational advancement.
 
What is an ERG?
ERGs are voluntary, employee-led organizations which foster diversity and inclusion in the workplace and are backed by leadership. Examples of ERGs include professional development groups and groups bringing together people with similar affinities (e.g., gender, ethnicity, veteran status, etc.). Employees are offered the opportunity to develop, lead and/or participate in them.
 
ERGs at CNH Industrial will strive to contribute to the following Six Pillars:
