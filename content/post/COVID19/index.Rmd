...
### Graph of cumulative reported cases by country
...
### Graph of cumulative reported US cases

```{r CumulativeUSCovidStates}
...
### Graph of cumulative US cases by county
...
nytcovcounty %>%
  ...
  labs(title = "COVID-19 Cumulative Recorded Cases by US County",
       ...
       x = "Days since first US case", y = "Count of Cases (log 10 scale)",
       caption = "@jim_gruman | Data: The New York Times")+
  theme(plot.title.position = "plot")
```

### Graph of cumulative Illinois cases by county
...
### Graph of incremental new Illinois cases by county
...
nytcovcounty %>%
  ...
  ggplot(aes(x = days_elapsed, y = NewCases, group = county, color = core, label = end_label)) +
  geom_line(size = 0.25) +
  geom_text_repel(nudge_x = 0.75,
                  segment.color = NA) +
  guides(color = FALSE) +
  ...
  guides(color = FALSE) +
  labs(title = "Illinois COVID-19 New Recorded Cases by County",
       subtitle = paste("Data as of", format(max(nytcovcounty$date), "%A, %B %e, %Y")),
       x = "Days since first US case", y = "New Cases",
       caption = "@jim_gruman | Data: The New York Times")+
  theme(plot.title.position = "plot")
```

### Graph of cumulative Illinois deaths by county
...
nytcovcounty %>%
  ...
  labs(title = "Illinois COVID-19 Cumulative Recorded Deaths by County",
       subtitle = paste("Data as of", format(max(nytcovcounty$date), "%A, %B %e, %Y")),
       x = "Days since first US case", y = "Count of Deaths (log 10 scale)",
       caption = "@jim_gruman | Data: The New York Times")+
  theme(plot.title.position = "plot")
```

### Graph of cumulative Iowa cases by county
...
### Graph of incremental Iowa cases by county
...
nytcovcounty %>%
  ...
  scale_y_log10(labels = scales::label_number_si()) +
  guides(color = FALSE) +
  labs(title = "Iowa COVID-19 New Recorded Cases by County",
       subtitle = paste("Data as of", format(max(nytcovcounty$date), "%A, %B %e, %Y")),
       x = "Days since first US case", y = "New Cases (log 10 scale)",
       caption = "@jim_gruman | Data: The New York Times")+
  theme(plot.title.position = "plot")
```

### Graph of cumulative Iowa deaths by county
...
### Graph of cumulative South Dakota cases by county
...
### Graph of cumulative South Dakota deaths by county
