...
CasesByCountry<-covnat %>%
  ...
  ggplot(mapping = aes(x = days_elapsed, y = cu_cases,
         ...
         group = cname)) +
  geom_line(aes(text = cname), size = 0.5) +
...
ggplotly(CasesByCountry, tooltip = c("text","cu_cases"))
```
...
CumulativeUSCovidStates<-covus %>%
  ...
  geom_line(aes(text = state),size = 0.5) +
...
ggplotly(CumulativeUSCovidStates, tooltip = c("state","count"))
```
