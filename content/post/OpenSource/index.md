...
One example: With pentabytes of data at hand, enterprises are trying to figure out the best way to understand their customers and themselves. But using Excel pivot tables to analyze massive quantities of information is absurd, so in the recent past companies would invest in a commercially available, proprietary, tool like `SAS` to create business intelligence.
